...
namespace FlagRTS
{
	...
	public:
		...
		{
			JumpResult Result;
			Array<IntVector2> Neighbours;
		};

	protected:
		UniformGridPathingMap* _pathingMap;
		Array2d<int> _codesMap; // Created from pathing map
		// Maps [x=dircode,y=cellcode] to CellResults
		Array2d<CellResult> _resultMap;
...
#pragma region DEBUG
	...
	protected: 
		...
		Array<DebugNode> _debugNodes;
		Array<std::pair<IntVector2,IntVector2>> _debugJumpPaths;
		Array<std::pair<IntVector2,IntVector2>> _debugJumpFarPaths;

		void FindSuccessorsDebug(const IntVector2& current, const IntVector2& parent, const IntVector2& goal, Array<IntVector2>& sucessors);
	...
	public:
		...
		Array<DebugNode>& GetLastExpandedNodes() { return _debugNodes; }
		Array<std::pair<IntVector2,IntVector2>>& GetJumpPaths() { return _debugJumpPaths; }
		Array<std::pair<IntVector2,IntVector2>>& GetJumpFarPaths() { return _debugJumpFarPaths; }
